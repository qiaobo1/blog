      ...
      <div id="login" class="container-fluid standard-bg">
         ...
         <div class="row header-top">
            ...
            <div class="col-lg-3 col-md-6 col-sm-7 hidden-xs">
               <div class="right-box">
                  <button type="button" class="access-btn" data-toggle="modal" data-target="#enquirypopup">获得免费获得</button>
               </div>
            </div>
         </div>
         <!-- MENU -->
               ...
               <nav class="navbar navbar-default">
                  ...
                  <div class="collapse navbar-collapse js-navbar-collapse megabg dropshd ">
                     <ul class="nav navbar-nav">
						...
						<li><a href="single-video.html">视频 后</a></li>
						<li><a href="single-page.html">单页-基本</a></li>
						<li><a href="single-page-with-img.html">单页-带图像</a></li>
						<li><a href="login.html">登录</a></li>
						<li><a href="gallery-video-boxed.html">图廊</a></li>
                        ...
                        <div class="login-register-content">
                           <div class="row" data-equalizer data-equalize-on="medium" id="test-eq">
                              <div class="col-md-12 text-center login-header">
                                 <h2 class="title main-head-title">用户登录-获取保费</h2>
                                 <p>乱数假文只是印刷排版业虚拟文本。乱数假文一直是行业的标准虚拟文本自从16</p>
                              </div>
                              <div class="clearfix spacer"></div>
                              <div class="col-md-5 social-login">
                                 <div class="social-login" data-equalizer-watch>
                                    <h2 class="title main-head-title">通过社交网站登录</h2>
                                    <div class="social-login-btn social-facebook">
                                       <a href="#"><i class="fa fa-facebook"></i>登录脸谱网</a>
                                    </div>
                                    <div class="social-login-btn social-twitter">
                                       <a href="#"><i class="fa fa-twitter"></i>登录推特</a>
                                    </div>
                                    <div class="social-login-btn social-google-plus">
                                       <a href="#"><i class="fa fa-google-plus"></i>通过谷歌登录</a>
                                    </div>
                                    <div class="social-login-btn social-youtube">
                                       <a href="#"><i class="fa fa-youtube"></i>登录YouTube</a>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-2">
                              ...
                              <div class="col-md-5">
                                 <div class="register-form">
                                    <h2 class="title main-head-title">创建您的帐户</h2>
                                    <form method="post" data-abide novalidate>
                                       ...
                                       <div class="checkbox">
                                          ...
                                          <label class="customLabel" for="remember">记得我</label>
                                       </div>
                                       <div class="login-btn-box">
                                          <button class="access-btn" type="submit" name="submit">现在登录</button>
                                       </div>
                                    </form>
                                 </div>
                              </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                     ...
                     <ul class="footer-menu-links">
                        ...
                        <li class="fa fa-chevron-right"><a href="#">类别</a></li>
                        <li class="fa fa-chevron-right"><a href="#">特征</a></li>
                        <li class="fa fa-chevron-right"><a href="#">页</a></li>
