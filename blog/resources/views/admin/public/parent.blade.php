            ...
            <!-- 菜单 -->
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub">
                        <li class="sidebar-nav-link">
                            <a href="{{ url('/user')}}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> 普通会员
                            </a>
                        </li>

                        <li class="sidebar-nav-link">
                            <a href="{{ url('/user')}}">
                                <span class="am-icon-angle-right sidebar-nav-link-logo"></span> VIP会员
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-nav-link">
                    <a href="calendar.html">
                        <i class="am-icon-calendar sidebar-nav-link-logo"></i> 栏目管理
                    </a>
                </li>
                ...
                <li class="sidebar-nav-link">
                    <a href="form.html">
                        <i class="am-icon-wpforms sidebar-nav-link-logo"></i> 广告管理

                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="chart.html">
                        <i class="am-icon-bar-chart sidebar-nav-link-logo"></i> 友情链接
